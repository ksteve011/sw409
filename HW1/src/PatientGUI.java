	...
	private void createPatientUI() {
		{
			...
			String[] patients = {"Patient 1", "Patient 2", "Patient 3", "Patient 4", "Patient 5"};
			
			final JComboBox<String> combobox = new JComboBox<String>(patients);
			...
			JButton exitApplicationButton = new JButton("Exit");
			
			exitApplicationButton.setBounds(270, 220, 80, 20);
			...
			jframe.add(exitApplicationButton);
